...
export default function SobreMim() {
  return (
    ...
    >
      ...
      <p className={styles.paragrafo}>A alura também conta com um projeto muito interessante chamado challenges, onde são propostos desafios específicos por área. O desafio fornece um design e requisitos de um projeto modelo, deixando a responsabilidade do desenvolvimento para o Aluno. E isso eu achei incrível pois me fez enxergar do quanto eu já era capaz e o quanto eu ainda preciso aprender. E pôr em prática é sem dúvidas uma das melhores formas de aprender.</p>
      ...
      <p className={styles.paragrafo}>Recentemente eu conheci também outro projeto incrível o SouJunior Lab, onde profissionais júniores podem adiquirir experiência participando de projetos voluntários e estou realmente achando fenomenal esta iniciativa. <a href="https://discord.gg/soujunior-community-759176734460346423" target="_blank">Discord do SouJunior Lab.</a></p>
    </PostModelo>
  )
}